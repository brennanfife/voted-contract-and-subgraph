// https://medium.com/blockrocket/how-to-create-date-strings-using-assemblyscript-in-the-graph-f7871f48e92d

import { BigInt, Voted } from "@graphprotocol/graph-ts/index";
...
function toBigInt(integer: any): BigInt {
...
export function dayMonthYearFromEventTimestamp(event: Voted): DayMonthYear {
